...
} from "./chunk-YPV3ONZE.js";
import {
  findIonContent,
  getScrollElement,
  printIonContentErrorMsg
} from "./chunk-HENYUDCS.js";
import "./chunk-Y6L42VLB.js";
import {
  isRTL
} from "./chunk-IYJE4RVC.js";
import {
  createLockController
} from "./chunk-HUCHNVCC.js";
import "./chunk-3W7OJCJA.js";
import {
  getTimeGivenProgression
} from "./chunk-GUFPAIDK.js";
import {
  attachComponent,
  detachComponent
} from "./chunk-MNQY7B4K.js";
import {
  createColorClasses,
  hostContext
...
import {
  getIonMode,
  isPlatform
} from "./chunk-I2AYINB3.js";
import {
  shouldUseCloseWatcher
} from "./chunk-5WL3KZBG.js";
import {
  transition
} from "./chunk-DDIY6A5Q.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
...
} from "./chunk-NNC7EJV3.js";
import "./chunk-CEGSF6PK.js";
import {
  Host,
  config,
  createEvent,
  ...
  componentDidLoad() {
    {
      rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-ceb5RaMT-6MYYPHYM.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-5DQ7Fc4V-BJY4ZOSM.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-DyOpfTg6-ALGJGWS7.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-CPLxO-Ev-MT7HGFF6.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-ywgs5efA-52G23S2R.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./focus-visible-BmVRXR1y-Z6W4TP4I.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
  /**
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-BKw2CAHc-FZR6PLGL.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-app_8.entry-OEBDAWJR.js.map
