...
} from "./chunk-PAMXS7VL.js";
import {
  isRTL
} from "./chunk-PH24BLOW.js";
import {
  createLockController
} from "./chunk-SPPZ6YAK.js";
import {
  findIonContent,
  getScrollElement,
  printIonContentErrorMsg
} from "./chunk-XSOM5DTV.js";
import "./chunk-AK32DX6B.js";
import "./chunk-EVJMRF4F.js";
import {
  getTimeGivenProgression
} from "./chunk-WF25DZ2Y.js";
import {
  attachComponent,
  detachComponent
} from "./chunk-GNQHA3SY.js";
import {
  createColorClasses,
  hostContext
} from "./chunk-IG6INNTC.js";
import {
  transition
} from "./chunk-IHSKM5NA.js";
import {
  getIonMode,
  isPlatform
} from "./chunk-FDPCTVX5.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
...
} from "./chunk-H6HVWDGJ.js";
import {
  shouldUseCloseWatcher
} from "./chunk-URCNHFDC.js";
import "./chunk-TSOIVI7A.js";
import {
  Host,
  config,
  createEvent,
  ...
  componentDidLoad() {
    {
      rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-ceb5RaMT-ZWY3TFFO.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-5DQ7Fc4V-JYNWQCM3.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-DyOpfTg6-656E3OOK.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-CPLxO-Ev-PBBECZAR.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-ywgs5efA-IGVWCQIB.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./focus-visible-BmVRXR1y-DJSRYRAL.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
  /**
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-BKw2CAHc-UOYPFYHZ.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-app_8.entry-IH7XZTOC.js.map
